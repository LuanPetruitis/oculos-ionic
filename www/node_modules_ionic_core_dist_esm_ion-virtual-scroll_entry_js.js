  ...
  \***********************************************************************/
      /***/ (
        ...
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ ion_virtual_scroll: () =>
            /* binding */ VirtualScroll,
          /* harmony export */
        });
        ...
        const createNode = (el, type) => {
          ...
          if (template && el.ownerDocument) {
            return el.ownerDocument.importNode(template.content, true)
              .children[0];
          }
        ...
        const positionForIndex = (index, cells, heightIndex) => {
          const cell = cells.find(
            (c) => c.type === CELL_TYPE_ITEM && c.index === index
          );
        ...
        const VirtualScroll = class {
          ...
          positionForItem(index) {
            return Promise.resolve(
              positionForIndex(index, this.cells, this.getHeightIndex())
            );
          }
          /**
          ...
          checkRange(offset, len = -1) {
            ...
            _home_luan_Documentos_TopicoEspecial_oculos_oculos_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__[
              ...
              const cells = calcCells(
                ...
                _this2.headerFn,
                _this2.footerFn,
                _this2.approxHeaderHeight,
                _this2.approxFooterHeight,
                _this2.approxItemHeight,
                cellIndex,
                offset,
                length
              );
          ...
          calcHeightIndex(index = 0) {
            ...
            this.heightIndex = resizeBuffer(
              this.heightIndex,
              this.cells.length
            );
            this.totalHeight = calcHeightIndex(
              this.heightIndex,
              this.cells,
              index
            );
