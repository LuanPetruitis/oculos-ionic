...
(self["webpackChunkapp"] = self["webpackChunkapp"] || []).push([
  ["common"],
  {
    /***/ 4693:
      /*!***************************************************!*\
  !*** ./src/app/pages/auth/login/login.service.ts ***!
  \***************************************************/
      /***/ (
        ...
        /* harmony import */ var _angular_fire_compat_auth__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(/*! @angular/fire/compat/auth */ 1115);
        /* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(/*! @ionic/angular */ 5472);

        let LoginService = class LoginService {
          constructor(nav, auth, toast) {
            this.nav = nav;
            this.auth = auth;
            this.toast = toast;
          ...
          showError() {
            return (0, tslib__WEBPACK_IMPORTED_MODULE_0__.__awaiter)(
              ...
              void 0,
              function* () {
                const ctrl = yield this.toast.create({
    ...
    /***/ 2901:
      /*!*******************************************************!*\
  !*** ./src/app/pages/oculos/service/oculo-service.ts ***!
  \*******************************************************/
      /***/ (
        __unused_webpack_module,
        __webpack_exports__,
        ...
        __webpack_require__.r(__webpack_exports__);
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ Carroservice: () => /* binding */ Carroservice,
          /* harmony export */
        });
        ...
        /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(/*! @angular/core */ 1109);
        /* harmony import */ var _angular_fire_compat_firestore__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(/*! @angular/fire/compat/firestore */ 4199);
        ...
        let Carroservice = class Carroservice {
          ...
          pegaCarro(id) {
            this.collection = this.db.collection("oculo", (ref) =>
              ref.where("id", "==", id)
            );
          ...
          remove(oculo) {
            ...
            this.collection
              .doc(oculo.id)
              .delete()
              .then(() => console.log("Apaguei"))
              .catch(() => console.log("Apaguei"));
          }
        };
        Carroservice.ctorParameters = () => [
          {
            type: _angular_fire_compat_firestore__WEBPACK_IMPORTED_MODULE_0__.AngularFirestore,
          },
        ];
        Carroservice = (0, tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)(
          [
  ...
  \*********************************************************************/
      /***/ (
        ...
        /* harmony import */ var _index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(/*! ./index-b3eecb14.js */ 6931);
        /* harmony import */ var _haptic_683b3b3c_js__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(/*! ./haptic-683b3b3c.js */ 3067);
        /* harmony import */ var _index_3f1a7d95_js__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(/*! ./index-3f1a7d95.js */ 7610);
        /*!
        ...
        const createButtonActiveGesture = (el, isButton) => {
          ...
          return (0,
          _index_3f1a7d95_js__WEBPACK_IMPORTED_MODULE_2__.createGesture)({
            el,
            ...
            onStart: (ev) =>
              activateButtonAtPoint(
                ev.currentX,
                ev.currentY,
                _haptic_683b3b3c_js__WEBPACK_IMPORTED_MODULE_1__.a
              ),
            onMove: (ev) =>
              activateButtonAtPoint(
                ev.currentX,
                ev.currentY,
                _haptic_683b3b3c_js__WEBPACK_IMPORTED_MODULE_1__.b
              ),
            onEnd: () => {
  ...
  \**************************************************************************/
      /***/ (
        ...
        /* harmony import */ var _home_luan_Documentos_TopicoEspecial_oculos_oculos_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(
            /*! ./node_modules/@angular-devkit/build-angular/node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js */ 1415
          );
        /* harmony import */ var _helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(/*! ./helpers-4d272360.js */ 3318);
        ...
        const attachComponent = /*#__PURE__*/ (function () {
          var _ref = (0,
          _home_luan_Documentos_TopicoEspecial_oculos_oculos_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__[
            "default"
          ])(function* (
            delegate,
            container,
            ...
            const el =
              typeof component === "string"
                ? (_a = container.ownerDocument) === null || _a === void 0
                  ? void 0
                  : _a.createElement(component)
                : component;
            ...
            yield new Promise((resolve) =>
              (0, _helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_1__.c)(
                el,
                resolve
              )
            );
          ...
          const attachViewToDom = /*#__PURE__*/ (function () {
            ...
            _home_luan_Documentos_TopicoEspecial_oculos_oculos_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__[
              ...
              if (userComponent) {
                 ...
                 */
                const el =
                  typeof userComponent === "string"
                    ? (_a = BaseComponent.ownerDocument) === null ||
                      _a === void 0
                      ? void 0
                      : _a.createElement(userComponent)
                    : userComponent;
                /**
                ...
                const el =
                  (_b = BaseComponent.ownerDocument) === null || _b === void 0
                    ? void 0
                    : _b.createElement("div");
  ...
  \*************************************************************/
      /***/ (
        ...
        /* harmony import */ var _helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(/*! ./helpers-4d272360.js */ 3318);
        /* harmony import */ var _index_9ac92660_js__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(/*! ./index-9ac92660.js */ 4468);
        ...
        const printIonContentErrorMsg = (el) => {
          return (0, _index_9ac92660_js__WEBPACK_IMPORTED_MODULE_2__.a)(
            el,
      ...
      /***/ (
        ...
        const printRequiredElementError = (el, ...targetSelectors) => {
          return console.error(
            `<${el.tagName.toLowerCase()}> must be used inside ${targetSelectors.join(
              " or "
            )}.`
          );
        };
          ...
          lines: {
            ...
            fn: (dur, index, total) => {
              const transform = `rotate(${
                (360 / total) * index + (index < total / 2 ? 180 : -180)
              }deg)`;
              const animationDelay = `${(dur * index) / total - dur}ms`;
              return {
                y1: 14,
  ...
  \******************************************************************/
      /***/ (
        ...
        /* harmony import */ var _helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(/*! ./helpers-4d272360.js */ 3318);
        /* harmony import */ var _dir_e8b767a8_js__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(/*! ./dir-e8b767a8.js */ 7106);
        /* harmony import */ var _index_3f1a7d95_js__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(/*! ./index-3f1a7d95.js */ 7610);
        /* harmony import */ var _gesture_controller_17e82006_js__WEBPACK_IMPORTED_MODULE_3__ =
          __webpack_require__(/*! ./gesture-controller-17e82006.js */ 4007);
        /*!
         * (C) Ionic http://ionicframework.com - MIT License
         */
        ...
        const createSwipeBackGesture = (
          ...
          const onEnd = (detail) => {
            ...
            onEndHandler(
              ...
              stepValue <= 0
                ? 0.01
                : (0, _helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_0__.l)(
                    0,
                    stepValue,
                    0.9999
                  ),
  ...
  \*************************************************************/
      /***/ (
        ...
        const openURL = /*#__PURE__*/ (function () {
          ...
          _home_luan_Documentos_TopicoEspecial_oculos_oculos_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__[
            "default"
          ])(function* (url, ev, direction, animation) {
